...
function RecordBox() {
  ...
  return (
    <div className="border-[0.5px] border-slate-600 h-auto w-[95vw] md:h-1/2 md:w-3/4 bg-white flex flex-col items-center rounded-2xl shadow-lg p-8 mx-auto">


      <div className="flex items-center gap-3 mb-8">
        <Headphones className="w-8 h-8 text-green-600 transition-colors duration-300 hover:text-green-800" />
        <h1 className="text-3xl font-bold text-gray-800 hover:text-gray-600 transition-colors duration-300">Collecte Audio</h1>
      </div>

      <div className="mb-4 text-sm text-gray-600">
        <span className="font-semibold text-gray-700">Utilisation de la mémoire :</span> 148 Mo
      </div>

      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-4 text-gray-800 hover:text-gray-600 transition-colors duration-300">
        ...
        <div className="flex flex-col items-center justify-end mb-6 p-5 bg-white/70 backdrop-blur-md rounded-2xl shadow-[0_2px_6px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all">
          ...
          <div className="flex flex-wrap items-center gap-2 max-w-[600px] mt-4">
        ...
        <div className="mb-6">
          <h3 className="font-medium text-gray-800 mb-2">Corpus actuel :</h3>
          <div className="p-4 bg-gray-100 rounded-md text-gray-700 shadow-sm hover:bg-gray-200 transition-colors duration-300">
